...
project_name = 'Sweet Papper'
dataset_name = 'ds'
work_dir = 'papper'
strawberry_url = 'https://storage.googleapis.com/kaggle-data-sets/1746816/2853388/bundle/archive.zip?X-Goog-Algorithm=' \
...
images_ext = '.png'
sample_percent = round(int(os.environ["modal.state.samplePercent"]) * 6.2)
class_name = 'pepper'
